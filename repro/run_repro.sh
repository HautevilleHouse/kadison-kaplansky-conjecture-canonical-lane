...
mkdir -p .tmp/kadison_kaplansky_conjecture
cp artifacts/stitch_constants.json .tmp/kadison_kaplansky_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .tmp/kadison_kaplansky_conjecture/constants_registry.json
