...
mkdir -p .codex_tmp/kadison_kaplansky_conjecture
cp artifacts/stitch_constants.json .codex_tmp/kadison_kaplansky_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .codex_tmp/kadison_kaplansky_conjecture/constants_registry.json
python3 scripts/kk_closure_guard.py --strict-coh-zero --registry artifacts/constants_registry.json --stitch artifacts/stitch_constants.json --out repro/certificate_runtime.json --history repro/drift_guard_runs.jsonl --pretty
