...
mkdir -p .repro_tmp/kadison_kaplansky_conjecture
cp artifacts/stitch_constants.json .repro_tmp/kadison_kaplansky_conjecture/stitch_constants.json
cp artifacts/constants_registry.json .repro_tmp/kadison_kaplansky_conjecture/constants_registry.json
